            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="{{ route('index') }}"
                        ...
                        {{ request()->routeIs('index') ? 'active' : '' }} ">Home</a>
                    <a href="{{ route('about') }}"
                        class="nav-item nav-link
{{ request()->routeIs('about') ? 'active' : '' }}">About</a>
                    <a href="{{ route('services') }}"
                        class="nav-item nav-link
{{ request()->routeIs('services') ? 'active' : '' }}">Services</a>
                    <a href="{{ route('packages') }}"
                        class="nav-item nav-link
{{ request()->routeIs('packages') ? 'active' : '' }}">Packages</a>
                    <a href="{{ route('blog') }}"
                        class="nav-item nav-link
{{ request()->routeIs('blog') ? 'active' : '' }}">Blog</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu m-0">
                            <a href="{{ route('destination') }}"
                                class="dropdown-item
                            {{ request()->routeIs('destination') ? 'active' : '' }}">Destination</a>
                            <a href="{{ route('tour') }}"
                                class="dropdown-item
                            {{ request()->routeIs('tour') ? 'active' : '' }}">Explore
                                Tour</a>
                            <a href="{{ route('booking') }}"
                                class="dropdown-item
                            {{ request()->routeIs('booking') ? 'active' : '' }} ">Travel
                                Booking</a>
                            <a href="{{ route('gallery') }}"
                                class="dropdown-item
                            {{ request()->routeIs('gallery') ? 'active' : '' }} ">Our
                                Gallery</a>
                            <a href="{{ route('guides') }}"
                                class="dropdown-item
                            {{ request()->routeIs('guides') ? 'active' : '' }} ">Travel
                                Guides</a>
                            <a href="{{ route('testimonial') }}"
                                class="dropdown-item
                            {{ request()->routeIs('testimonial') ? 'active' : '' }} ">Testimonial</a>
